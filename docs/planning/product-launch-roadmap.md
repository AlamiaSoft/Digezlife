...
| **Hisaab (Wallets & Transfers)** | Multi-wallet tracking (Cash, Bank, Mobile Wallet) and account-to-account transfers. | ⏳ In Progress | Basic cashflow active; wallet segmentation to be refined before launch. |
