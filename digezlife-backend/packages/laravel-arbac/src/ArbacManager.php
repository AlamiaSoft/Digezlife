...
class ArbacManager
{
    ...
    public function createRole(string $name, ?string $displayName = null, ?string $description = null)
    {
        return Role::create([
            'name' => $name,
    ...
    {
        return $user instanceof \Alamia\Core\Authorization\Models\SuperAdmin;
    }
