...
use Alamia\Core\Audit\Http\Middleware\LogActivity;
use Alamia\Core\Audit\Models\AuditLog;
use Alamia\Core\Authorization\Http\Middleware\TenantAdminOnly;
use Alamia\Core\Authorization\Models\SuperAdmin;
use Alamia\Core\Identity\Models\OAuthProvider;
use Alamia\Core\Kernel\Http\Middleware\ApiVersionMiddleware;
use Alamia\Core\Middleware\EnsureSuperAdmin;
use Alamia\Core\Shared\Http\Middleware\ValidateJsonApi;
use Alamia\Core\Tenant\Http\Middleware\CheckTenantStatus;
use Alamia\Core\Tenant\Http\Middleware\EnsureUserBelongsToTenant;
use Alamia\Core\Tenant\Jobs\CreateDomainStep;
use Alamia\Core\Tenant\Jobs\ProvisionDatabaseStep;
use Alamia\Core\Tenant\Jobs\RunMigrationsStep;
use Alamia\Core\Tenant\Jobs\SeedTenantStep;
...
return [
    ...
    */
    ...
    'middleware' => [
        ...
        'tenant_admin' => TenantAdminOnly::class,
        'identify_tenant' => InitializeTenancyByPath::class,
        'check_tenant_status' => CheckTenantStatus::class,
        'user_belongs_to_tenant' => EnsureUserBelongsToTenant::class,
        'validate_jsonapi' => ValidateJsonApi::class,
        'log_activity' => LogActivity::class,
