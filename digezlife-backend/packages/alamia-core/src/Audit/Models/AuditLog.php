...
namespace Alamia\Core\Audit\Models;
 ...
 *
 * @method static \Illuminate\Database\Eloquent\Builder<static>|AuditLog action(string $action)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|AuditLog byExternalId(string $externalId)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|AuditLog currentTenant()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|AuditLog dateRange($startDate, $endDate)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|AuditLog forTenant($tenantId)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|AuditLog forUser($userId, ?string $userType = null)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|AuditLog resource(string $resourceType, $resourceId)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|AuditLog resourceType(string $resourceType)
 *
 * @mixin \Eloquent
 */
